...
export default function MovieDetails() {
  ...
  return (
    <div className="min-h-screen text-white bg-gray-900">
      ...
      <button
        onClick={() => navigate(-1)}
        className="fixed z-50 w-10 p-2 transition rounded-full top-20 left-8 bg-black/50 hover:bg-black/70"
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url(https://image.tmdb.org/t/p/original${
              movie.backdrop_path || movie.poster.replace("w500", "original")
            })`,
          }}
        >
